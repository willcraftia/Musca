...
namespace Musca
{
    ...
    public sealed class Simplex : NamedObject, INoiseSource
    {
        ...
        public float Sample(float x, float y, float z)
        {
            ...
            float ys = y + s;
            float zs = z + s;
            int i = MathHelper.Floor(xs);
            int j = MathHelper.Floor(ys);
            int k = MathHelper.Floor(zs);
            ...
            {
                t0 *= t0;
                n0 = t0 * t0 * MathHelper.CalculateGradient(
            ...
            {
                t1 *= t1;
                n1 = t1 * t1 * MathHelper.CalculateGradient(
            ...
            {
                t2 *= t2;
                n2 = t2 * t2 * MathHelper.CalculateGradient(
            ...
            {
                t3 *= t3;
                n3 = t3 * t3 * MathHelper.CalculateGradient(
